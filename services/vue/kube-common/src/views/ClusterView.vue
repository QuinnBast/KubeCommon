  ...
  <div class="m-4">
      ...
      <BInputGroup prepend="Viewing Cluster:" class="mt-3">
        <BDropdown :text="currentContext" variant="primary" class="me-2" :key="contextList">
          <BDropdownItem
            ...
            :key="context.name"
            @click="setContext(context.name)"
            >{{ context.name }}</BDropdownItem
          >
        </BDropdown>
      </BInputGroup>
    </BContainer>
    ...
    <BContainer>
      ...
      <BRow>
        <BCol cols="2">
          <BListGroup>
            <BListGroupItem href="" @click="switchTab('Namespace')" :active="isActive('Namespace')"
              >Namespaces</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('ConfigMap')" :active="isActive('ConfigMap')"
              >Configmaps</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('Secret')" :active="isActive('Secret')"
              >Secrets</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('Pod')" :active="isActive('Pod')"
              >Pods</BListGroupItem
            >
            <BListGroupItem
              href=""
              ...
              >Deployments</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('Service')" :active="isActive('Service')"
              >Services</BListGroupItem
            >
            <BListGroupItem
              href=""
              @click="switchTab('ReplicaSet')"
              :active="isActive('ReplicaSet')"
              >Replica Sets</BListGroupItem
            >
            <BListGroupItem
              href=""
              @click="switchTab('StatefulSet')"
              :active="isActive('StatefulSet')"
              >Stateful Sets</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('DaemonSet')" :active="isActive('DaemonSet')"
              >Daemon Sets</BListGroupItem
            >
            <BListGroupItem href="" @click="switchTab('Node')" :active="isActive('Node')"
              >Nodes</BListGroupItem
            >
          </BListGroup>
        </BCol>
        <BCol>
